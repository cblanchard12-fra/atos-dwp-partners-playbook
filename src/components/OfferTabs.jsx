...
export function TabIdentity({ partner, editMode, updatePartner }) {
  ...
  // Logo via Clearbit si URL logo définie, sinon fallback sur initiales
  const LogoOrInitials = () => {
    if (partner.logo_url && !editMode) {
      return (
        <div style={{ width: 56, height: 56, borderRadius: 10, border: '0.5px solid var(--border)', background: 'white', display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'hidden', flexShrink: 0 }}>
          <img
          ...
          />
          <div style={{ display: 'none', width: 56, height: 56, borderRadius: 10, background: partner.color + '22', color: partner.color, alignItems: 'center', justifyContent: 'center', fontSize: 18, fontWeight: 500 }}>
            {partner.initials}
          </div>
        </div>
      )
    ...
    return (
      <div style={{ width: 56, height: 56, borderRadius: 10, background: partner.color + '22', color: partner.color, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 18, fontWeight: 500, flexShrink: 0 }}>
        {editMode
