      ...
      <aside className="sidebar">
        <div className="sidebar-head">
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 8 }}>
            ...
            <div style={{ fontSize: 10, fontWeight: 600, color: 'var(--text2)', letterSpacing: '0.3px', lineHeight: 1.4 }}>
              <div style={{ fontSize: 11, fontWeight: 600, color: 'var(--text)' }}>Sales Playbook</div>
              <div style={{ color: 'var(--text3)', fontWeight: 400 }}>{data.length} partenaires</div>
            </div>
          </div>
